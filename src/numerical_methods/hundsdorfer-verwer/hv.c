...
//                 diff_term = select_compute_diffusion_term(is_aligned, Vm, elements, i, j, Nx, Ny, delta_x, delta_y);
...
//                 idx = i * Nx + j;
//                 prevY = Y[idx];
//                 diff_term = select_compute_diffusion_term_x(is_aligned, Vm, elements, i, j, Nx, Ny, delta_x, delta_y);
...
//                 idx = i * Nx + j;
//                 prevY = auxVm[idx];
//                 diff_term = select_compute_diffusion_term_y(is_aligned, Vm, elements, i, j, Nx, Ny, delta_x, delta_y);
