...
typedef void (*numerical_method_t)(const SimulationConfig *, Measurement *, const real *, const CellModelSolver *, real *, real *, ElementProperties *);
...
void runSSIADI_CUDA(const SimulationConfig *config, Measurement *measurement, const real *time_array, const CellModelSolver *cell_model_solver_CUDA, real *Vm, real *sV, ElementProperties *elements);
void runOSADI_CUDA(const SimulationConfig *config, Measurement *measurement, const real *time_array, const CellModelSolver *cell_model_solver_CUDA, real *Vm, real *sV, ElementProperties *elements);
void runFE_CUDA(const SimulationConfig *config, Measurement *measurement, const real *time_array, const CellModelSolver *cell_model_solver_CUDA, real *Vm, real *sV, ElementProperties *elements);
